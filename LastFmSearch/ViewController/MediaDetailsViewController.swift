...
class MediaDetailsViewController: UIViewController {
    ...
    private func setMediaImage(images: [[String: String]]) {
        ...
        self.imageView.af.setImage(withURL: url, imageTransition: .curlDown(0.4))
        self.banerImageView.af.setImage(withURL: url, filter: BlurFilter(blurRadius: 20), imageTransition: .crossDissolve(0.4))
    }
